...
export const Icons = {
	logo: (props: LucideProps) => (
		<svg
			...
			x="0px"
			y="0px"
			viewBox="0 0 35.569 35.569"
			color="#DAFFFB"
			// style="enable-background:new 0 0 35.569 35.569;"
			// xml:space="preserve"
		>
			<g>
				<path
					d="M24.847,5.245c-5.164,2.551-8.593,2.347-13.934-0.042c-9.353,0-14.715,25.162-7.719,25.162
